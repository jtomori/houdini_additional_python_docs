...
project = u'Houdini Python modules'
copyright = u'2018, jtomori'
author = u'jtomori'
...
htmlhelp_basename = 'HoudiniPythonmodulesdoc'
...
latex_documents = [
    (master_doc, 'HoudiniPythonmodules.tex', u'Houdini Python modules Documentation',
     u'jtomori', 'manual'),
]
...
man_pages = [
    (master_doc, 'houdinipythonmodules', u'Houdini Python modules Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HoudiniPythonmodules', u'Houdini Python modules Documentation',
     author, 'HoudiniPythonmodules', 'One line description of project.',
     'Miscellaneous'),
]
